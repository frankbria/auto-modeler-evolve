...
- [x] **Model selection** — User picks their preferred model via chat or button.
...
- [x] **Feature importance (SHAP)** — Global feature importance chart. "The top 3
      factors driving predictions are: region, season, and product category"
- [x] **Individual prediction explanations** — SHAP waterfall for single predictions.
