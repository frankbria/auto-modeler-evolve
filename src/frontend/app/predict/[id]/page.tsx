...
import type { Deployment, FeatureSchemaEntry, PredictionResult, PredictionExplanation, FeatureContribution, ConfidenceInterval, GuardRailWarning, DashboardFieldEntry } from "@/lib/types"
...
// NOTE: A cross-deployment "Compare Model Versions" card used to live here. It
// was removed because it enumerated sibling deployments via the owner-scoped
// GET /api/deployments?project_id=… endpoint from this PUBLIC page, leaking
// sibling deployment IDs/metadata to anyone holding a single share link (IDOR,
// issue #25). Model comparison is an owner-only operation; it belongs behind
// auth in the project workspace, never on the public prediction surface.
