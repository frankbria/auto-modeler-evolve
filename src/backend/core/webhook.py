...
EVENT_HIGH_ACTIVITY_BURST = "high_activity_burst"
EVENT_LATENCY_ALERT = "latency_alert"
EVENT_ROLLBACK_TRIGGERED = "rollback_triggered"
EVENT_PRED_VALUE_TREND_ALERT = "pred_value_trend_alert"
EVENT_INPUT_DIST_DRIFT = "input_dist_drift"
EVENT_DEGRADATION_RETRAIN = "degradation_retrain"
